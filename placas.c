...
#define h (double)0.009765625 // Longitud de cada celda de la rejilla, tal que celdas=512
#define N (int)(2*pow((L/h),2)) // Numero de iteraciones
#define n (int)(L/h) // Numero de celdas por eje (512)
...
void valores_fijos(double *grid, int inicial, int final); // Fija valores
